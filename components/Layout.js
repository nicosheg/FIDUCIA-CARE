...
export default function Layout({ children }) {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        /* ---------- Living Canvas – no decorations, just depth ---------- */
        .livingCanvas {
          position: fixed;
        ...
        /* Ambient drifts – almost invisible, just for life */
        ...
        .ambientDrift2 {
          background: radial-gradient(ellipse at 60% 40%, rgba(212,175,55,0.015) 0%, transparent 60%);
        ...
        /* ---------- Main Content ---------- */
        .mainContent {
          position: relative; z-index: 1; padding-bottom: 40px; min-height: 100vh;
        }
        ...
        .fiducia-card {
          ...
          padding: 24px;
          margin-bottom: 18px;   /* increased spacing between cards */
        }
        .fiducia-card:active {
