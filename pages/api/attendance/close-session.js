...
// FIDUCIA CARE — Finalize an active attendance session.
// Only owners/admins can finalize.
// Present records are confirmed, session is closed, participation is generated.
...
export default withAdmin(async function handler(req,res){
 ...
 try{
  ...
  // Attendance is committed before downstream intelligence generation.
  setImmediate(()=>{
   generateParticipationFromSession(session_id,orgId).catch(err=>{
    console.error('[ATTENDANCE] Participation generation failed:',err);
   });
  });
