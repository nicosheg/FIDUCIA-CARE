// FILE: pages/api/attendance/close-session.js
// Confirms present attendance, closes the active session, then generates participation.
...
export default withOrg(async function handler(req, res) {
  ...
  try {
    ...
    // Source-of-truth attendance is committed before ARIA processing begins.
    setImmediate(() => {
