...
await pool.query('INSERT INTO organization_invites(organization_id,invited_by,email,role,token_hash,expires_at) VALUES($1,$2,$3,$4,$5,$6)',[user.organization_id,user.id,null,role,tokenHash,expires]);
