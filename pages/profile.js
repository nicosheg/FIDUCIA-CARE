...
export default function ProfilePage(){
  ...
  if(loading)return <Layout><div className="wrap"><div className="loading">Loading profile…</div></div></Layout>;
