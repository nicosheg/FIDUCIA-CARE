  ...
  return (
    <Layout>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '20px' }}>
        <h1 style={{ fontSize: 28, fontWeight: 600, color: '#f0f0f0', marginBottom: 30 }}>
        ...
        {people.length > 0 && (
          <>
            ...
            {showAddForm && (
              <form onSubmit={addPerson} className="fiducia-card" style={{ marginBottom: 28, display:'flex', flexDirection:'column', gap:12 }}>
            ...
            {message && <div className="fiducia-card" style={{ padding:10, marginBottom:20, color:'#34D399' }}>{message}</div>}
              ...
              {filtered.map((person, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13, marginBottom: 6 }}>{person.phone || 'No phone'}</div>
                    <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, marginBottom: 12 }}>{person.last_attended_date ? `Last seen ${person.last_attended_date}` : 'New'}</div>

                    {selectedPerson?.id === person.id && (
                      <div style={{ paddingTop: 15, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
