...
export async function getAttentionItems(orgId) {
  ...
  // 3. Birthdays this week (people with birthday metadata)
  ...
  // 4. People who missed the last 2 Sundays (using attendance records)
  ...
  // High: prayer requests older than 7 days
