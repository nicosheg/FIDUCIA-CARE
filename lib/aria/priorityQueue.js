  ...
  const res = await pool.query(
    `WITH combined AS (
      SELECT
        ...
        lt.status AS living_truth_status,
        ...
        (CASE
          ...
          WHEN lt.status IN ('needs_decision', 'conflict') THEN 40
