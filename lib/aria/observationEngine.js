...
function computeAttention(confidence, severity, urgency, createdAt = new Date()) {
  ...
  // Base score: confidence * severity * urgency
  let score = confidence * severityWeight * urgencyWeight * 100;
  
  // Add recency bonus: observations in the last 24 hours get +10
 ...
 * Groups by type and returns counts, average attention, etc.
 */
