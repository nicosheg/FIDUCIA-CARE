...
const[relationships,memberships,roles,fields,lifecycle,documents,tasks,communications,timeline,observations,actions,memory,aliases]=await Promise.all([
...
return{...p.rows[0],relationships,memberships,roles,fields,lifecycle,documents,tasks,communications,timeline,observations,actions,memory,aliases,groups:groups.rows};
}
