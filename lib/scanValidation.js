...
import pool from './db';
import { getThreshold as importedGetThreshold } from './identityConfig';
import { normalizePhone as importedNormalizePhone } from './phoneUtils';
import { normalizeConfidence as importedNormalizeConfidence } from './confidenceUtils';

// ---- FALLBACKS (ensure functions exist even if imports fail) ----
const normalizePhone = importedNormalizePhone || function(phone) {
...
const normalizeConfidence = importedNormalizeConfidence || function(value, defaultVal = 70) {
...
const getThreshold = importedGetThreshold || function(name) {
  const map = {
...
// -------- Normalization (exported function) --------
