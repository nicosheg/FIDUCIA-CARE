...
import normalizePhone from './phoneUtils';      // default import
...
export function fuzzyMatch(str1, str2) {        // ← EXPORTED
...
// -------- Re-export normalizePhone as named export (for identityResolver) --------
