...
import { normalizePhone } from './phoneUtils';  // <-- import from shared utility
...
function validatePhone(phone) {
  ...
  // We already validated length/format in normalizePhone, but we also check for all-same-digit.
